...
router.put('/victim/:id', function (req, res) {
  ...
  pg.connect(connectionString, function (err, client, done) {
    ...
    client.query('UPDATE victim ' +
                ...
                'WHERE id = $74',
                [victim.something, victim.something, victim.something, victim.something,  victim.something, victim.something, victim.something, victim.something, victim.something, victim.something, victim.something, victim.something, victim.something, victim.something, victim.something, victim.something, victim.something, victim.something, victim.something, victim.something, victim.something, victim.something, victim.something, victim.something,  victim.something, victim.something, victim.something, victim.something, victim.something, victim.something, victim.something, victim.something, victim.something, victim.something, victim.something, victim.something, victim.something, victim.something, victim.something, victim.something, victim.something, victim.something, victim.something, victim.something, victim.something, victim.something, victim.something, victim.something, victim.something, victim.something, victim.something, victim.something, victim.something, victim.something, victim.something, victim.something, victim.something, victim.something, victim.something, victim.something, victim.something, victim.something, victim.something, victim.something, victim.something, victim.something, victim.something, victim.something, victim.something, victim.something, victim.something, victim.something, victim.something, id],
                function (err, result) {
                  done();
