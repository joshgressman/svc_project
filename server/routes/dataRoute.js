...
router.put('/victim/:id', function(req, res) {
    ...
    pg.connect(connectionString, function(err, client, done) {
        ...
        client.query('UPDATE victim ' +
            ...
            'victim_gender = $55, ' +
            'victim_trans = $56, ' +
            'victim_sexual_orientation = $57, ' +
            'disability_blind = $58, ' +
            'disability_physical = $59, ' +
            'disability_mental = $60, ' +
            'disability_deaf = $61, ' +
            'disability_developmental = $62, ' +
            'disability_other = $63, ' +
            'disability_other_specify = $64, ' +
            'disability_unknown = $65, ' +
            'disability_none = $66, ' +
            'victim_ethnicity = $67, ' +
            'victim_immigrant = $68' +
            'homeless = $69, ' +
            'limited_english = $70, ' +
            'veteran = $71, ' +
            'supported_on_call = $72 ' +
            'WHERE id = $73',
            [newVictim.something, newVictim.something, newVictim.something, newVictim.something, newVictim.something, newVictim.something, newVictim.something, newVictim.something, newVictim.something, newVictim.something, newVictim.something, newVictim.something, newVictim.something, newVictim.something, newVictim.something, newVictim.something, newVictim.something, newVictim.something, newVictim.something, newVictim.something, newVictim.something, newVictim.something, newVictim.something, newVictim.something, newVictim.something, newVictim.something, newVictim.something, newVictim.something, newVictim.something, newVictim.something, newVictim.something, newVictim.something, newVictim.something, newVictim.something, newVictim.something, newVictim.something, newVictim.something, newVictim.something, newVictim.something, newVictim.something, newVictim.something, newVictim.something, newVictim.something, newVictim.something, newVictim.something, newVictim.something, newVictim.something, newVictim.something, newVictim.something, newVictim.something, newVictim.something, newVictim.something, newVictim.something, newVictim.something, newVictim.something, newVictim.something, newVictim.something, newVictim.something, newVictim.something, newVictim.something, newVictim.something, newVictim.something, newVictim.something, newVictim.something, newVictim.something, newVictim.something, newVictim.something, newVictim.something, newVictim.something, newVictim.something, newVictim.something, newVictim.something, id],
